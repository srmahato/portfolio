              ...
              itemBuilder: (context, index) {
                return WidgetAnimator(
                  child: ProjectCard(
                    ...
                    backImage: mProjectsBanner[index],
                    projectIcon: mProjectsIcons[index],
                    projectTitle: mProjectsTitles[index],
                    projectDescription: mProjectsDescriptions[index],
                    projectLink: mProjectsLinks[index],
